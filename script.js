...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var texts = ["Im Abyss","I'm an idiot","I'm always pushed aside.","always the excess friend.","Never Needed Anywhere.",'I Feel So Fucking ALONE.',"just let me be SELFISH for once.","whenever i need help, im all alone.","I've done it all alone anyways.","I Don't Need Anyone.","I'm Still here...","Right?","I'll Bear This Burden.","Alone."];
    var counter = 0;
    var currentText = "";
    var isDeleting = false;
    var typingSpeed = 100; // Adjust typing speed (in milliseconds)
